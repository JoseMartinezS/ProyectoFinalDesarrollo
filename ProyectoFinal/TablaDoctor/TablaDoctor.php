...
<?php
    ...
    echo "
    <th style='display: none;'>idDoctor</th>
    ...
    {
        echo "<tr>";
        //echo "<td class='table-secondary'>".$registro["idDoctor"]."</td>";
        echo "<td class='table-secondary'>".$registro["nombre"]."</td>";
        echo "<td class='table-secondary'>".$registro["apellidop"]."</td>";
        echo "<td class='table-secondary'>".$registro["apellidom"]."</td>";
        //echo "<td class='table-secondary'>".$registro["estatus"]."</td>";
        echo "<td class='table-secondary'>

        <div class='button-container'>
        <form action='EliminarDoctor.php' method='post' onsubmit=\"return confirm('¿Estás seguro de que deseas eliminar esta compra?')\">
            <input type='hidden' name='idDoctor' value='".$registro["idDoctor"]."'>
            <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idDoctor"]."' value='Eliminar'>
        </form>
        <form action='ActualizarDoctor.php' method='post'>
            <input type='hidden' name='idDoctor' value='".$registro["idDoctor"]."'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idDoctor"]."' value='Modificar'>
        </form>
        </div>
...
<div class="button-containerr">
  ...
  <form action="RegistrarDoctor.php" method="get">
