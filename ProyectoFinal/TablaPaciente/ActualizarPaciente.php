            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    <div class="card-body p-4 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Actualizar Paciente</h3>
                        <?php
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            echo '</div>';
                            echo '<div class="form-outline mb-4">';
                            echo '<input type="text" name="apellidoPaterno" id="form3Example1q" class="form-control" value="' . $registro['apellidop'] . '"/>';
                            ...
                            echo '<p>No se encontraron datos para el Paciente seleccionado.</p>';
                        }
